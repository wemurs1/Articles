...
public record CreateAndAssignAuthorCommand(int? UserId, string? FirstName, string? LastName, string? Email, string? Title, string? Affiliation,
    bool IsCorrespondingAuthor, HashSet<ContributionArea> ContributionAreas) : ArticleCommand
{
    ...
    public CreateAndAssignAuthorCommandValidator()
    {
        When(c => c.UserId == null, () =>
        {
            ...
            RuleFor(x => x.LastName)
                ...
                .MaximumLengthWithMessage(MaxLength.C64, nameof(CreateAndAssignAuthorCommand.LastName));
            ...
            RuleFor(x => x.Affiliation)
                ...
                .MaximumLengthWithMessage(MaxLength.C64, nameof(CreateAndAssignAuthorCommand.Affiliation));
